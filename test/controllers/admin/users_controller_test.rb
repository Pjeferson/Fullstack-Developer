...
class Admin::UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "invalid attributes redirect back to the index with errors" do
    sign_in_as(@admin)
  ...
  test "an invalid update redirects back to the index with errors, without changing the user" do
    sign_in_as(@admin)

    patch admin_user_path(@user), params: { email_address: "", full_name: "" }
