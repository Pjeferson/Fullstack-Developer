...
Gives an admin an at-a-glance, live-updating view of the User base — total count and a
breakdown by role — shown directly above the User list they already land on after signing in.
